create or replace view dbax_tablespaces_v as
...
'<a href="dbax_dbadmin.datafiles?p_tablespace_name=' || d.tablespace_name || '&' || 'p_total=' || 
sum(d.bytes) || '&' || 'p_free=' || nvl(f.free_bytes,0)||'" target="main">Datafiles</a>' drilldown,
